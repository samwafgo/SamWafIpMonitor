...
namespace SamWafIpMonitor.wrapper
{
    public class WindowTitle
    {
        ...
        //    return sb.ToString();
        //}
        public static string GetFileNameFromPid(int pid)
        {
            try
            {
            ...
            {
                // Some processes, especially those running under higher privileges, may not allow access to their MainModule properties.
                return "";
            }
        }
